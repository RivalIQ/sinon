...
function stub(object, property) {
    ...
    // NOTE first-class stubbing of streamline functions does not work -- the stub will not
    // be called; throw if this is attempted, to avoid silent misbehavior
    if (isStubbingExistingMethod) {
        if (actualDescriptor.value.name === "wrapper") {
            throw new TypeError("Streamline functions cannot be stubbed");
        }
    }
